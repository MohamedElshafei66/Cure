    ...
    return Scaffold(
      backgroundColor: Colors.white,
       appBar: AppBar(
        ...
        title: Text(AppStrings.settings,style: AppStyle.styleRegular24(context),),
        centerTitle: true,
      ),
      ...
      body:Padding(
        ...
        child: Column(children: [
          ProfileItem(icon: AppIcons.password, title: "Password Management"),
           Gap(30),
           ProfileItem(icon: AppIcons.person, title: "Delete Account",showArrow: false,),
