...
class _VisaPaymentScreenState extends State<VisaPaymentScreen> {
  ...
  static const String methodName = "Visa";
  ...
  Future<void> fetchPaymentMethods() async {
    ...
    if (data is List) {
      ...
      for (var card in cards) {
        print('💳 VISA Card - methodName: ${card['methodName']}, brand: ${card['brand']}');
      }
    } else {
      setState(() => cards = []);
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("VISA Cards", style: AppStyle.styleRegular24(context)),
        centerTitle: true,
      ),
      body: isLoading
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Gap(8),
                      Text(
                        "Add your VISA card to make payment easier",
