...
class ApplePayPaymentScreen extends StatefulWidget {
  const ApplePayPaymentScreen({super.key});

  @override
  State<ApplePayPaymentScreen> createState() => _ApplePayPaymentScreenState();
}

class _ApplePayPaymentScreenState extends State<ApplePayPaymentScreen> {
  bool isLoading = true;
  List<Map<String, dynamic>> cards = [];
  static const String methodName = "ApplePay";
  ...
  Future<void> fetchPaymentMethods() async {
    ...
    if (data is List) {
      ...
      for (var card in cards) {
        print('💳 ApplePay - methodName: ${card['methodName']}, brand: ${card['brand']}');
      }
    } else {
      setState(() => cards = []);
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Apple Pay", style: AppStyle.styleRegular24(context)),
        centerTitle: true,
      ),
      body: isLoading
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Gap(20),
                      Text(
                        "No Apple Pay cards yet!",
                        style: AppStyle.styleRegular24(context),
                      ),
                      const Gap(8),
                      Text(
                        "Add your Apple Pay card to make payment easier",
              ...
              : Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Gap(20),
                      CustomButton(
                        text: "Add Another Apple Pay Card",
