...
abstract class AppointmentRepo{
  Future<Either<Failure, String>> fetchAvailableSlots(String doctorId);
  Future<Either<Failure,AppointmentEntity>>  bookAppointment(AppointmentEntity appointmentEntity );
}